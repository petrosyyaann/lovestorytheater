  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text>
            <span color='#C08F55'>“История вашей любви”</span>— необыкновенное
          ...
          <Text>
            <span color='#C08F55'>Станьте ей на время</span>, чтобы больше
            понять про себя и про вашу вторую половинку.
          </Text>
          <Text>
          ...
          <Text>
            <span color='#C08F55'>Участвуйте в истории</span>, пересоздавая и
            укрепляя свои отношения.
          </Text>
        </Flex>
        <Flex
